...
public class PaymentTM {
    ...
    public PaymentTM(String pay_Code, String teach_Id, Double pay_Cost, String relevent_Year, String relevent_Month, Date pay_Date, String pay_Time, String status) {
        Pay_Code = pay_Code;
        Teach_Id = teach_Id;
        Pay_Cost = pay_Cost;
